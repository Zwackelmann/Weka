...
import weka.core.matrix.MemorySavingMatrix;
...
implements AttributeTransformer, OptionHandler {
  ...
  private void buildAttributeConstructor (Instances data) throws Exception {
    ...
    System.out.println("building giant matrix");
    // double [][] trainValues = new double[m_numAttributes][m_numInstances];
    MemorySavingMatrix trainValues = new MemorySavingMatrix(m_numInstances, m_numAttributes);
    System.out.println("giant matrix ready");
    
    for (int i = 0; i < m_numAttributes; i++) {
        trainValues.addColumn(m_trainInstances.attributeToDoubleArray(i));
    }
    ...
    SingularValueDecomposition trainSVD = trainValues.svd();
